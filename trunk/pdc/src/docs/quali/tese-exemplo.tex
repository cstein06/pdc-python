% Texto de qualificação de Carlos Stein para Bioinformática
% Baseado no Arquivo LaTeX de exemplo de dissertação/tese de Jesús Chalco - V 3
% 
...
\input cap-background        % associado ao arquivo: 'cap-conclusoes.tex'
